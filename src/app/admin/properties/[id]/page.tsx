...
import { PropertyLocations } from '@/components/admin/PropertyLocations'
import { PropertyAssets } from '@/components/admin/PropertyAssets'
import { PropertyMoreInfo } from '@/components/admin/PropertyMoreInfo'
...
type Tab = 'content' | 'visual_assets' | 'viewings' | 'locations' | 'more_info'
