...
import { Scene, PerspectiveCamera, WebGLRenderer, ACESFilmicToneMapping, SRGBColorSpace, AmbientLight, DirectionalLight, Box3, Vector3, Color, EquirectangularReflectionMapping } from 'three';
